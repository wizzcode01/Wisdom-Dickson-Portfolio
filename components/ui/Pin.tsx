...
return (
  <a
    ...
    className={cn(
      "relative group/pin z-50 block cursor-pointer",
      containerClassName
    )}
    onMouseEnter={onMouseEnter}
    onMouseLeave={onMouseLeave}
  >
    {/* the animated 3D content */}
    <div
      style={{
        perspective: "1000px",
        transform: "rotateX(70deg) translateZ(0deg)",
    ...
    <motion.div className="pointer-events-auto w-full h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500">
      <div className=" w-full h-full -mt-7 flex-none  inset-0">
        <div className="absolute top-0 inset-x-0  flex justify-center">
          ...
          >
           <span className="relative z-20 text-white text-xs font-bold inline-block py-0.5 px-4 w-full truncate">
              {title}
            </span>
